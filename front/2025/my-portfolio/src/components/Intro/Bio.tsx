...
const texts = [
    ...
    "의견을 제시하고 수용하면서",
    "함께 성장하는 과정을 즐깁니다. ",
    "새로운 것을 좋아하며, 꼼꼼하게 정리하며,",
    "대화를 통해 프로젝트를 수행합니다.",
    "긍정적인 마음, 시간 약속의 중요성, 끊임없는 성장을",
    "삶의 중요한 가치로 두고 있습니다.",
];
    ...
    return (
        <div className={`${styles.intro} inner sticky left-0 top-0 flex items-center text-center z-[2] min-h-[100vh]`}>
            <div className="w-full mx-auto 2xl:w-4/5">
                <div className="flex flex-wrap justify-center text-xs text-gray-900 sm:text-sm dark:text-gray-300 lg:text-lg xl:text-xl 2xl:text-2xl">
